...
GUI-only release. macOS 15+ universal signed/notarized DMG; experimental Ubuntu 24.04 x86_64 and ARM64 archives. Requires an existing Herdr daemon. Source: $source_sha.
