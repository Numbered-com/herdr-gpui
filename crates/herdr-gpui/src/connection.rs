...
use herdr_client::{
    ClientEvent, ClientHandle, ConnectOptions, ConnectTarget, connect_with_surface_active,
...
impl ConnectionBridge {
    ...
    fn start(
        ...
        let result = connect_with_surface_active(self.target.clone(), options, surface_active)
            .and_then(|client| {
