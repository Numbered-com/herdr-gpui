//! Adapted from herdr src/protocol/endpoint.rs (Apache-2.0, see NOTICE.md).
//! Modified: only client-facing gen1 handshake types/constants retained.
use crate::ClientSurfaceSize;
